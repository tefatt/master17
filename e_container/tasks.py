...
def fetch_all_device_group_statuses(municipality):
    ...
    if message and message.data:
        ...
        # header.append(update_device_group_status.s(locations, vehicles, group_dem, depot))
        # if header:
